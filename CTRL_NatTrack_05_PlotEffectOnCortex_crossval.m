%%% This code corresponds to analysis requested during peer-review. It
%%% plots crosscorrelation coefficients and lags for the specified condition and 
%%% frequency band, corresponding to each one of the 10 iterations in the
%%% CLTR_NatTrack_03_StatsCrosval code. Each iteration has to be plot
%%% separately.
%%%
%%% Osorio & Assaneo, 2025
...
% load data to plot
load([data_dir,filesep,'CROSdata_',band2analyze, '_' num2str(k2plot) '_crossval_whitenoise.mat']);
